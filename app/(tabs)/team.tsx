...
const styles = StyleSheet.create({
  ...
  overviewValue: { fontSize: FontSize.xxl, fontWeight: '800', color: Colors.text, letterSpacing: -0.5 },
  overviewLabel: { fontSize: FontSize.xs, color: Colors.textSecondary, marginTop: 2, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.4 },
